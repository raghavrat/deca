  ...
  return (
    <article className="mx-auto max-w-4xl px-5 py-14 text-neutral-800 dark:text-neutral-200">
      <header className="mb-12 border-b border-neutral-200 pb-8 dark:border-neutral-800">
        <p className="mb-3 text-sm text-neutral-600 dark:text-neutral-400">Effective and last updated July 20, 2026</p>
      ...
      <div className="legal-copy space-y-10">
        <section>
          ...
          <ul>
            <li><strong>Account information:</strong> email address, display name, Firebase user ID, email-verification status, and account creation time.</li>
        ...
        <section>
          ...
          <p>We also use Google Firebase for authentication and database services and Vercel or a comparable hosting provider to deliver the website. These providers process information for us under their applicable service terms.</p>
        </section>
        ...
        <section>
          ...
          <p>We use one strictly necessary, HTTP-only session cookie that expires after five days and local storage for theme and on-device practice statistics. We do not currently use advertising cookies or third-party behavioral analytics. If that changes, this policy and any required consent controls must be updated before deployment.</p>
        </section>

        <section>
          <h2>Retention</h2>
          <p>Account profiles, learning totals, transcripts, and AI feedback are kept while the account remains active and are deleted when the user completes the in-product account deletion process, subject to limited legal, fraud-prevention, backup, or security exceptions. The session cookie expires after five days. Browser-only information remains until you clear site data or delete your account from that browser. Service-provider logs and backups follow the providers’ retention schedules.</p>
        </section>
        ...
        <section>
          ...
          <p>We use access controls, encrypted transport, restricted server-side database access, secure cookies, input limits, and dependency monitoring. No security measure is perfect. Firebase Authentication operates from the United States and other providers may process information in the United States or other locations where they operate.</p>
        </section>
