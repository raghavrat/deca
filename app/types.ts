...
export interface DECAScenario {
  ...
  // Career Competencies (kept under the legacy key for saved-session compatibility)
  centurySkills: string[];

  // Research-backed generation choices used for this practice scenario
  practiceMetadata?: {
    format: 'individual-series' | 'principles' | 'team-decision' | 'personal-financial-literacy';
    archetypeId: string;
