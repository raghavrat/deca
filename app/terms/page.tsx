  ...
  return (
    <article className="mx-auto max-w-4xl px-5 py-14 text-neutral-800 dark:text-neutral-200">
      ...
      <div className="legal-copy space-y-10">
        ...
        <section><h2>Changes and discontinuation</h2><p>We may add, change, suspend, replace, or discontinue any feature, plan, or all of Deca Pal at any time, including when we decide to stop operating the service. When reasonably practicable, we will provide advance notice of a material discontinuation. Any change or discontinuation remains subject to applicable law and rights that cannot legally be waived. If applicable law requires a refund or credit for prepaid, unused service, we will provide it.</p></section>
        <section><h2>Paid plans and renewals</h2><p>If paid plans are offered, the price, billing interval, included features, trial terms, and any applicable taxes will be shown before purchase. Subscriptions renew automatically until canceled. Upgrades may take effect immediately; downgrades and cancellations generally take effect at the end of the current billing period. You can manage an active subscription through the account or pricing interface. A one-time “lifetime” purchase provides the stated access for as long as the Deca Pal service continues to operate and the purchasing account remains active; it is personal, non-transferable, and subject to reasonable rate, abuse-prevention, and service limits. Except where required by law, charges are non-refundable; contact us if you believe a charge was made in error. Payment availability may be limited by country, currency, tax, or payment-authentication requirements.</p></section>
